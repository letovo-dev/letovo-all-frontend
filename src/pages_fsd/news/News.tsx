...
//   scrollPosition?: { scrollPosition: boolean; offsetTop: number };
// }

// const News: React.FC<NewsProps> = ({ children, scrollPosition }) => {
...
//     console.log('News', document.querySelector('.newsContainer'));

//     document.querySelector('.newsContainer')?.scrollTo({
...
const News: React.FC<NewsProps> = ({ children, onContainerRef }) => {
  ...
  useEffect(() => {
    if (onContainerRef && wrapRef) {
      ...
      console.log('Passed wrapRef to parent:', wrapRef.current);
    }
  }, [onContainerRef]);
